            ...
            <table class = "menu-container" border = "0">
                ...
                <tr class = "menu-row" >
                    <td class = "menu-btn menu-icon-session">
                        <a href = "schedule.php" class = "non-style-link-menu"><div><p class = "menu-text">All Sessions</p></div></a>
                    </td>
                </tr>
                <tr class = "menu-row" >
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Seamlessly book your appointments and track your sessions by clicking on
                                <a href = "doctors.php" class = "non-style-link"><b>"All Doctors"</b></a> section or 
                                <a href = "appointment.php" class = "non-style-link"><b>"Appointments"</b> </a><br>
                                Track your past and future appointments.<br>Easily find out the session availability of various doctors.<br><br>
                            </p>            
                            <h3>Channel a Doctor Here</h3>
                            <form action = "schedule.php" method = "post" style = "display: flex">
                                <input type = "search" name = "search" class = "input-text " placeholder = "Search Doctor to find session availability" list = "doctors" style = "width:45%;">&nbsp;&nbsp;                                
                                <?php
                                ...
                                <td width = "50%">
                                    <center>
                                        <table class = "filter-container" style = "border: none;" border = "0">
                                            ...
                                            <tr>
                                                <td style = "width: 25%;">
                                                    <div  class = "dashboard-items"  style = "padding:25px;margin:auto;width:200%;display: flex">
                                                        <div>
