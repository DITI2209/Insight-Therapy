                ...
                <tr>
                   <td colspan = "4">
                       <center>
                        ...
                        <table width = "93%" class = "sub-table scrolldown"  style = "border-spacing:3;">
                        <thead>
                        <tr>
                        ...
                        <tbody>
                            <?php
                                ...
                                if($result->num_rows == 0){
                                    ...
                                    <br><br><br><br>
                                    <center>
                                    <img src="../img/notfound.svg" style="margin-left: 20em" width="25%">
                                    <br>
                                    &nbsp;&nbsp;&nbsp;&nbsp; <p class="heading-main12" style="margin-left: 17em;font-size:20px;color:rgb(49, 49, 49)"> No patients have been scheduled yet!  </p>
                                    <a class="non-style-link" href="patient.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:22em;">&nbsp; Show all Patients &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
